...
class SurrealSymbolProcessor(private val codeGenerator: CodeGenerator, private val logger: KSPLogger) : SymbolProcessor {
    override fun process(resolver: Resolver): List<KSAnnotated> {
        ...
        val tableDeclarations = resolver.getSymbolsWithAnnotation("annotation.Table").map { it as KSClassDeclaration }
        val relationDeclarations = resolver.getSymbolsWithAnnotation("annotation.Relation").map { it as KSClassDeclaration }
        val objectDeclarations = resolver.getSymbolsWithAnnotation("annotation.Object").map { it as KSClassDeclaration }
    ...
    classes.forEach {
        ...
        builder.addProperty(
            PropertySpec.builder(
                ...
                core.Table::class.asTypeName().parameterizedBy(
                    it.toClassName(),
