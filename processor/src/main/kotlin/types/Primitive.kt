...
sealed class Primitive: SurrealFieldType {
    object StringField: Primitive() {
        ...
        override fun getSurrealTypeFunction(): CodeBlock {
            return CodeBlock.of("%M", MemberName("types", "stringType"))
        }
    }
    object BooleanField: Primitive() {
        ...
        override fun getSurrealTypeFunction(): CodeBlock {
            return CodeBlock.of("%M", MemberName("types", "booleanType"))
        }
    }
    object LongField: Primitive() {
        ...
        override fun getSurrealTypeFunction(): CodeBlock {
            return CodeBlock.of("%M", MemberName("types", "longType"))
        }
    }
    object DoubleField: Primitive() {
        ...
        override fun getSurrealTypeFunction(): CodeBlock {
            return CodeBlock.of("%M", MemberName("types", "doubleType"))
        }
    }
    object DurationField: Primitive() {
        ...
        override fun getSurrealTypeFunction(): CodeBlock {
            return CodeBlock.of("%M", MemberName("types", "durationType"))
        }
    }
    object DateTimeField: Primitive() {
        ...
        override fun getSurrealTypeFunction(): CodeBlock {
            return CodeBlock.of("%M", MemberName("types", "dateTimeType"))
        }
    }
}